...
addon_info = {
	...
	"addon_version": "1.0",
	# Author(s)
	"addon_author": "Hoàng Long",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/Hoang-Long2012/ClearClipboard",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/Hoang-Long2012/ClearClipboard/tree/main/addon/globalPlugins/ClearClipboard",
